...
실행 후 집계: [적용 보고서](../../db-migration/schema-application-report.json).
필드 설명: [전체 테이블 명세](../../db-migration/새_DB_테이블_필드_명세.md).
