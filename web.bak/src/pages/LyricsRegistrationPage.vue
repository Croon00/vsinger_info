...
.lyrics-artist-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:0}.lyrics-artist-card{min-height:210px;padding:20px;border:1px solid var(--line);border-radius:11px;color:#8b98ad;background:var(--panel);cursor:pointer}.lyrics-artist-card>span{position:relative;display:grid;place-items:center;width:92px;height:92px;margin:0 auto 4px;overflow:hidden;border-radius:50%;color:var(--cyan);background:rgba(50,214,255,.06);font:700 12px ui-monospace,monospace}.lyrics-artist-card img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}.lyrics-artist-card strong,.lyrics-artist-card small{display:block}.lyrics-artist-card strong{overflow:hidden;color:#d9e3ef;font-size:15px;line-height:1.4;text-overflow:ellipsis;white-space:normal;overflow-wrap:anywhere}.lyrics-artist-card small{margin-top:0;color:#56647a;font:10px ui-monospace,monospace;white-space:nowrap}.lyrics-artist-card:hover,.lyrics-artist-card.active{transform:translateY(-2px);border-color:rgba(50,214,255,.45);background:linear-gradient(145deg,rgba(50,214,255,.1),rgba(154,124,255,.04));box-shadow:0 12px 30px rgba(0,0,0,.2)}.lyrics-song-form-panel{margin-top:18px}.selected-artist-line{display:flex;justify-content:space-between;margin-bottom:18px;padding-bottom:14px;border-bottom:1px solid var(--line)}.selected-artist-line span,.lyrics-cost-note{color:#718096;font-size:9px}@media(max-width:1100px){.lyrics-artist-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}@media(max-width:700px){.lyrics-artist-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
</style>
