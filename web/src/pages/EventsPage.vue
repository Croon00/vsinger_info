...
<style scoped>
.schedule-controls{display:flex;align-items:end;gap:18px;margin-bottom:14px;padding:17px 20px}.schedule-controls label,.filter-group{display:grid;gap:7px;color:#8491a6;font-size: 11px;font-weight:700}.schedule-controls select{min-width:180px}.view-switch{display:flex;margin-left:auto;border:1px solid var(--line);border-radius:7px;overflow:hidden}.view-switch button{height:38px;padding:0 15px;border:0;color:#748198;background:transparent;cursor:pointer}.view-switch button.active{color:var(--cyan);background:rgba(50,214,255,.08)}.calendar-panel{padding:0;overflow:hidden}.calendar-header{display:grid;grid-template-columns:42px 1fr 42px;align-items:center;padding:20px;text-align:center;border-bottom:1px solid var(--line)}.calendar-header button{height:38px;border:1px solid var(--line);border-radius:8px;color:#a8b5c7;background:rgba(255,255,255,.02);font-size: 30px;cursor:pointer}.calendar-header p{margin:0 0 4px;color:var(--cyan);font:700 10px ui-monospace,monospace;letter-spacing:.16em}.calendar-header h2{margin:0;font-size: 25px}.calendar-weekdays,.calendar-grid{display:grid;grid-template-columns:repeat(7,minmax(0,1fr))}.calendar-weekdays span{padding:10px;border-right:1px solid var(--line);color:#637087;text-align:center;font:700 10px ui-monospace,monospace}.calendar-day{min-height:135px;padding:9px;border-top:1px solid var(--line);border-right:1px solid var(--line);background:rgba(255,255,255,.008)}.calendar-day:nth-child(7n){border-right:0}.calendar-day>time{display:grid;place-items:center;width:25px;height:25px;margin-bottom:6px;color:#8c99ac;font:700 11px ui-monospace,monospace}.calendar-day.muted{opacity:.3}.calendar-day.today>time{border-radius:50%;color:#061017;background:var(--cyan)}.calendar-event{display:block;margin-top:5px;padding:7px;border-left:2px solid var(--cyan);border-radius:3px;background:rgba(50,214,255,.075)}.calendar-event b,.calendar-event strong,.calendar-event span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.calendar-event b{color:var(--cyan);font:700 10px ui-monospace,monospace}.calendar-event strong{margin-top:3px;color:#d9e3ef;font-size: 11px}.calendar-event span{margin-top:3px;color:#718096;font-size: 10px}.calendar-notice{margin:0;padding:13px 20px;color:var(--amber);font-size: 11px;border-top:1px solid var(--line)}.event-kind{display:inline-block!important;padding:5px 7px;border-radius:5px;color:var(--cyan);background:rgba(50,214,255,.08)}.event-kind--ticket{color:var(--amber);background:rgba(255,202,98,.08)}@media(max-width:820px){.schedule-controls{align-items:stretch;flex-direction:column}.schedule-controls select{min-width:0}.view-switch{margin-left:0}.calendar-day{min-height:90px;padding:5px}.calendar-event span,.calendar-event b{display:none}.calendar-event strong{font-size: 10px}.calendar-weekdays span{padding:8px 2px}}
...
.duplicate-count{display:block;margin-top:3px;color:var(--amber);font:700 9px ui-monospace,monospace}
.calendar-day{min-height:175px;cursor:pointer;transition:background .18s,box-shadow .18s}.calendar-day:hover{background:linear-gradient(145deg,rgba(50,214,255,.13),rgba(154,124,255,.06));box-shadow:inset 0 0 0 1px rgba(50,214,255,.38)}.calendar-day:hover>time{color:#061017;background:var(--cyan)}.calendar-day:focus-visible{outline:2px solid var(--cyan);outline-offset:-2px}.calendar-weekdays span{font-size: 13px}.calendar-day>time{width:30px;height:30px;font-size: 14px;transition:color .18s,background .18s}.calendar-event{padding:9px}.calendar-event b{font-size: 13px}.calendar-event strong{font-size: 15px;line-height:1.35}.calendar-event span{font-size: 13px}.duplicate-count{font-size: 11px}.day-schedule-list{display:grid;gap:10px}.day-schedule-item{display:flex;align-items:start;justify-content:space-between;gap:18px;padding:15px;border:1px solid var(--line);border-left:3px solid var(--cyan);border-radius:8px;background:rgba(50,214,255,.05)}.day-schedule-item time{color:var(--cyan);font:700 14px ui-monospace,monospace}.day-schedule-item h3{margin:7px 0 5px;font-size: 20px}.day-schedule-item p{margin:0;color:#8d9bb0;font-size: 15px}.day-schedule-item .text-link{flex:none;padding-top:3px}@media(max-width:820px){.calendar-day{min-height:115px}.calendar-event strong{font-size: 13px}.calendar-event span,.calendar-event b{display:block}.day-schedule-item{display:grid;gap:10px}.day-schedule-item h3{font-size: 18px}}
</style>
